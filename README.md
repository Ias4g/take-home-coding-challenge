...
Após rodar o projeto, se tudo der certo aparecerá no console a mensagem ``Well done!`` e um arquivo ``produto.json`` será criado na raiz do sistema. Caso dê erro apresentará ``Something went wrong!``
